...
router.post('/sendResetPasswordEmail',(req,res,next)=>{
  ...
  _subject = typeof (req.body.subject) === 'string' && req.body.subject !== 'undefined' ? req.body.subject : 'CloudMeetIn Reset Password';
...
function sendMessage(auth) {
  ...
  const raw = makeBody(_email, '',_subject,_message);
