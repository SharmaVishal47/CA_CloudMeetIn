...
export class ZoomIntegrationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.httpClient.post<any>('https://dev.cloudmeetin.com/zoom/checkintegrationstatus',{user_id: this.user_id}).subscribe((responseData)=>{
    ...
    if((this.user_id && this.zoomCode) && !this.alreadyIntegrated) {
      if(this.zoomCode && this.user_id) {
        this.httpClient.post<any>('https://dev.cloudmeetin.com/zoom/zoomcallback',{code: this.zoomCode, user_id: this.user_id}).subscribe((responseData)=>{
  ...
  disconnectZoomIntegration() {
    this.modalService.confirm({
      ...
      nzCancelText: 'Cancel',
      nzOnOk: () =>{
        this.httpClient.post<any>('https://dev.cloudmeetin.com/zoom/disconnectzoomintegration',{user_id: this.user_id}).subscribe((responseData)=>{
          this.integrationService.getMeetingPlatforms(this.user_id).subscribe((response) => {
