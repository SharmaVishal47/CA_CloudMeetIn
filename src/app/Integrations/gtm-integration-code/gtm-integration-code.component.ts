  ...
  ngOnInit() {
    ...
    /*  let client_id_client_secret64 = window.btoa("2dWCGOZLt9Y28Rmc0xfWNz84kPGkEpfA"+':'+"9uFMfxwb5tG1zK0O");
      let httpHeaders = new HttpHeaders({
        ...
        'Authorization': 'Basic MmRXQ0dPWkx0OVkyOFJtYzB4ZldOejg0a1BHa0VwZkE6OXVGTWZ4d2I1dEcxekswTw=='
      });
      let optionsHeader = {
        headers: httpHeaders
      };*/
      this.httpClient.post<any>('/meeting/gtm-connection',{code: this.paramCode}).subscribe(
        res =>{
          ...
          this.httpClient.post<{message: string,data: []}>('/integration/gotomeetingAdd',body,).subscribe((responseData)=>{
