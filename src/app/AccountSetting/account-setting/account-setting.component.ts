...
export class AccountSettingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.meetingService.getSelectedMeetingPlatform(this.userId).subscribe((responseData) => {
      ...
      let sMeetingPlatform  = typeof (responseData.data[0].selectedMeetingPlatform) === 'string' && responseData.data[0].selectedMeetingPlatform !== 'undefined'
      && responseData.data[0].selectedMeetingPlatform.split('').length > 0
      && responseData.data[0].selectedMeetingPlatform != null ? responseData.data[0].selectedMeetingPlatform : false;
      if(sMeetingPlatform) {
