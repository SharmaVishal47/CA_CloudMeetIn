...
export class AdminService {
  ...
  onSubmitAdminRecord(adminData: any) {
    this.httpClient.post<any>('https://dev.cloudmeetin.com/admin/admin-login',adminData).subscribe((responseData)=>{
  ...
  getUserRecords() {
   return this.httpClient.get<any>('https://dev.cloudmeetin.com/admin/userRecords')
  }
