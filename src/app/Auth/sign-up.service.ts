...
export class SignUpService {
  ...
  updateRoleOfUser(formData){
      this.httpClient.get<any>(API_URL+'/user/getlocation').subscribe((responseLocation) => {
        console.log("Respone of Location ss --- > ", responseLocation);
        console.log("Respone of Location 1 --- > ", responseLocation.data);
        console.log("Respone of Location 2--- > ", responseLocation.city);
        console.log("Respone of Location 3--- > ", responseLocation.data.city);
  ...
  updateAvailabilityConfiguration(formData){
    this.httpClient.post<any>(API_URL+'/user/updateConfiguration',formData).subscribe((responseData)=>{
  ...
  public updateCalendarEventOptions(event,calendarOptions,email){
    ...
    this.httpClient.post<any>(API_URL+'/user/updateCalendarEvent',data).subscribe((responseData)=>{
  ...
  public getCalendarEventsList(email: string){
    this.httpClient.post<any>(API_URL+'/user/getcalendarlist',{email: email}).subscribe( (responseData)=>{
  ...
  public updateTimeZoneUserId(email,timeZone,userId){
    this.httpClient.post<any>(API_URL+'/user/updateUser',{email: email,timeZone: timeZone,userId: userId}).subscribe((responseData)=>{
  ...
  public generateGmailAuthUrl() {
    this.httpClient.get<any>(API_URL+'/googleCalendar/signupcal').subscribe((responseData) => {
      /*this.httpClient.get<any>('/googleCalendar/signupcal').subscribe((responseData) => {*/
 ...
 /* public checkUserEmail(signUpData){
    this.httpClient.post<any>('/user/checkuseremail',signUpData).subscribe((responseData)=>{
  ...
  public checkUserEmail(signUpData){
    this.httpClient.post<any>(API_URL+'/user/checkuseremail',signUpData).subscribe((responseData)=>{
      this.checkEmail.next(responseData);
    },error => {
      this.messageService.generateErrorMessage(JSON.stringify(error));
    });
  ...
  public updateUserProfile(profileData){
    ...
    this.httpClient.post<any>(API_URL+'/user/updateUserProfile',profileData).subscribe((responseData)=>{
  ...
  public checkUser(formData){
    this.httpClient.post<{message: string,data: []}>(API_URL+'/user/checkuser',formData).subscribe((responseData)=>{
  ...
  public updateToken(token: string,emailId: string, userId:any, calendarId:string){
    this.httpClient.post<any>(API_URL+'/googleCalendar/updateToken',{_token: token, email: emailId,userId:userId,calendarId:calendarId}).subscribe((responseData)=>{
  ...
  getUserAuthToken(userEmail: string) {
    this.httpClient.post<any>(API_URL+'/userData/sendVerificationLink',{email: userEmail}).subscribe((responseUserTokenData)=>{
      console.log("responseUserTokenData -- > ", responseUserTokenData);
      this.httpClient.post<any>(API_URL+'/sendResetPasswordEmail/sendResetPasswordEmail',{
  ...
  public signUpByEmail(data){
    ...
    this.httpClient.post<any>(API_URL+'/userEmail/createSignupToken',data).subscribe((responseData)=>{
      console.log('responseData----------------->',responseData.data.length);
      if(responseData.data.length>0){
        let token = responseData.data[0].token;
        let srcData =  "/calenderOption/signupData?signupData="+token;
        ...
        this.httpClient.post<any>(API_URL+'/sendSignupEmail/signupEmail',{
  ...
  checkTokenData(data:string){
    this.httpClient.post<any>(API_URL+'/userEmail/checkSignUpToken',{token:data}).subscribe((responseData)=>{
  ...
  public generateGmailAuthUrlByEmail() {
    this.httpClient.get<any>(API_URL+'/googleCalendar/signupcalbyemail').subscribe((responseData) => {
      window.location.href = responseData.url;
    }, error => {
      this.messageService.generateErrorMessage(JSON.stringify(error));
    });
  ...
  public generateToken(token: string,emailId: string){
    ...
    this.httpClient.post<any>(API_URL+'/googleCalendar/generateTokenSignUpEmail',{_token: token, email: emailId}).subscribe((responseData)=>{
      this.generateTokenSubject.next(responseData);
    }, error => {
      this.messageService.generateErrorMessage(JSON.stringify(error));
      /*const dialogConfig = new MatDialogConfig();
  ...
  public generateTokenBySignOn(token: string,emailId: string){
    this.httpClient.post<any>(API_URL+'/googleCalendar/generateTokenSignOn',{_token: token, email: emailId}).subscribe((responseData)=>{
      this.generateTokenSubject.next(responseData);
    }, error => {
      this.messageService.generateErrorMessage("Please click on 'Connect' button and select the registered email for calendar.");
