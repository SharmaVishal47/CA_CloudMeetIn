...
const googleGmailSecrets = JSON.parse(fs.readFileSync('credentials_one.json')).installed;
module.exports = {
  ...
  zoom_redirect_url: 'https://cloudmeetin.com/integrations/zoommeeting',
  google_calendar: {
  ...
  google_gmail: {
    google_cal_client_id: googleGmailSecrets.client_id,
    google_cal_client_secret: googleGmailSecrets.client_secret,
    google_cal_redirect_url: googleGmailSecrets.redirect_uris[0]
  }
};
