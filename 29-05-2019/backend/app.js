...
app.use('/integrations/gotomeeting/:id',express.static(path.join(__dirname, '../CloudMeetIn')));
app.use('/:id',express.static(path.join(__dirname, '../CloudMeetIn')));
app.use('/changePassword/:id',express.static(path.join(__dirname, '../CloudMeetIn')));
app.use('/reschedule/:id',express.static(path.join(__dirname, '../CloudMeetIn')));
app.use('/cancellations/:id',express.static(path.join(__dirname, '../CloudMeetIn')));
app.use('/:userId/:selectTime',express.static(path.join(__dirname, '../CloudMeetIn')));
app.use('/:userId/:selectTime/:schedulingPage',express.static(path.join(__dirname, '../CloudMeetIn')));
module.exports = app;
